      ...
      <AdminHeader
        ...
        rightExtra={
          <button
            ...
            style={{ background: creando ? (dark ? "rgba(198,138,149,0.22)" : "rgba(198,138,149,0.14)") : (dark ? "rgba(198,138,149,0.14)" : "rgba(198,138,149,0.08)"), border: `1.5px solid ${dark ? "#6a3a42" : "#e8c6cc"}`, borderRadius: 12, padding: "9px 18px", color: dark ? "#e8b4bc" : "#C68A95", fontSize: 13, cursor: "pointer", fontFamily: "Montserrat, sans-serif", display: "flex", alignItems: "center", gap: 7 }}
          >
