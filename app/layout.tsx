  ...
  "@graph": [
    ...
    },
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { "@type": "Offer", itemOffered: { "@type": "Product", name: "Sérums con ácido hialurónico", category: "Skincare" }, priceCurrency: "CLP", availability: "https://schema.org/InStock" },
          { "@type": "Offer", itemOffered: { "@type": "Product", name: "Vitamina C sérum", category: "Skincare" }, priceCurrency: "CLP", availability: "https://schema.org/InStock" },
          { "@type": "Offer", itemOffered: { "@type": "Product", name: "Protector solar facial", category: "Protección Solar" }, priceCurrency: "CLP", availability: "https://schema.org/InStock" },
          { "@type": "Offer", itemOffered: { "@type": "Product", name: "Crema hidratante", category: "Hidratación" }, priceCurrency: "CLP", availability: "https://schema.org/InStock" },
          { "@type": "Offer", itemOffered: { "@type": "Product", name: "Limpiador facial", category: "Limpieza" }, priceCurrency: "CLP", availability: "https://schema.org/InStock" },
        ],
      },
    },
    {
