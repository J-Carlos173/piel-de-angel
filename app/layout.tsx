  ...
  "@graph": [
    ...
    },
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          { "@type": "Offer", itemOffered: { "@type": "Service", name: "Limpieza Facial Profunda", url: `${SITE_URL}/limpieza-facial-profunda`,    description: "Purificación profunda que elimina impurezas y devuelve luminosidad al rostro." } },
          ...
          { "@type": "Offer", itemOffered: { "@type": "Service", name: "Hidratación Facial", url: `${SITE_URL}/hidratacion-facial`,          description: "Restaura la hidratación profunda con activos premium." } },
          { "@type": "Offer", itemOffered: { "@type": "Service", name: "Tratamiento Anti-edad", url: `${SITE_URL}/tratamiento-anti-edad`,       description: "Protocolos personalizados anti-edad y revitalizantes." } },
          ...
          { "@type": "Offer", itemOffered: { "@type": "Service", name: "Diseño y depilación de cejas", url: `${SITE_URL}/perfilado-de-cejas`, description: "Definición y cuidado profesional de cejas." } },
