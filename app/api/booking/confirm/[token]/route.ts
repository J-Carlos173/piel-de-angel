...
export async function GET(
  ...
  try {
    ...
    await sendConfirmationToClient(data);

    return new NextResponse(
      `<!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Cita confirmada</title>
    ...
    return new NextResponse(
      ...
      <h2 style="color:#c00;">Error</h2><p>El enlace expiró o ya fue usado.</p></body></html>`,
      { headers: { "Content-Type": "text/html" } }
    );
  }
}
